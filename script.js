...
const repeatMyParam = () => {
    axios.get('http://localhost:3000/repeat/small-world')
    .then(response =>{
        console.log('Response', response.data)
        let repeatText = document.getElementById("repeat-text")
        repeatText.style.display = 'block';
        repeatText.style.backgroundColor = 'red';
...
// let repeatMyParam1 = document.getElementById("#repeat-text")
// repeatMyParam1.textContent = response.data 
...
// CODE HERE
// ? needed to start query 
let getRequest = () => {
    axios.get('http://localhost:3000/query-test?hello_world')   // needs underscores 
